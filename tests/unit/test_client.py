...
class TestFlareSolverrClientHTTP:
    ...
    def test_get_request_posts_to_path_endpoint(self):
        ...
        assert call_kwargs[0][0] == "http://localhost:8191/v1/request/get"
    ...
    def test_post_request(self):
        ...
        call_kwargs = mock_post.call_args
        assert call_kwargs[0][0] == "http://localhost:8191/v1/request/post"
